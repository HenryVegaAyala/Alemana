...
<script>
    ...
    function jsCalcular() {
        ...
        document.getElementById("Factura_TOT_FACT_SIN_IGV").value = totalNaN(redondear2decimales(sumaSubTotal));
        document.getElementById("Factura_TOT_IGV").value = totalNaN(redondear2decimales(montoIGV));
//        document.getElementById("Factura_TOT_FACT").value = redondear2decimales(total);
        document.getElementById("Factura_TOT_FACT").value = totalNaN(redondear2decimales(total));
    }
...
//        check();
    ...
    function crearFunciones(i) {
        ...
        psclient = document.getElementById('Factura_COD_CLIE').value;
        pstienda = document.getElementById('Factura_COD_TIEN').value;
        row = i;

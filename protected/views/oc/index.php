                    ...
                    'buttons' => array(
                        ...
                        'update' => array(
                            ...
                            'click' => "function (){
                                    ...
                                    if(id == 1 || id == 2 || id == 9){
                                        alert ('Este N° de O.C no puede ser actualizado debe tener el estado creado.');
                                        return false
                                    }
                        ...
                        'Anular' => array(
                            ...
                            'click' => "function (){
                                    ...
                                    if(id == 9 ){
                                     ...
                                     if (confirm ('¿Estas seguro de anular este N° de O.C?')){
                                            return true;
                                        }
                                            return false;
                                    }
...
//                                'visible' => 'array("$data->IND_ESTA") < 1',
                            ...
                            'click' => "function (){
                                    ...
                                    if(id == 2 ||  id == 9){
                                        alert ('No puede generarse la Guía, la O.C debe estar en su estado creado.');
                                        return false
                                    }
                                    if(id == 1 ){
                                        alert ('En este N° de O.C ya fue generado su Guía, Por Favor revisar.');
                                        return false;
                                    }else{
                                     if (confirm ('¿Estas seguro de generar la Guía para esta O.C ?')){
                                            return true;
                                        }
                                            return false;
                                    }
            ...
            <div class="col-sm-offset-2 col-sm-10">
                ...
                <script>
                    function validation(code) {
                        ...
                        if (!confirm('¿Estas seguro de usar la opción masiva de las Guías?, Sólo se consideraran aquellas O.C en estado creado.')) {
                            return false;
                        }

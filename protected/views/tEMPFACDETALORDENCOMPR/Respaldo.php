...
<form id='students' method='post' name='students'>
    ...
    <table class="table table-bordered table-condensed table-responsive table-striped table-hover table-wrapper">
        ...
        <tr>
            ...
            <td><input type="text" id='campo_COD_PROD' name='COD_PROD[]' size="10" class="form-control"/></td>
            ...
            <td><input type="text" id='campo_VAL_MONT_UNID' name='VAL_MONT_UNID[]' size="10" class="form-control"/> </td>
        </tr>
    </table>
    <br>
...
<script>
    ...
    $(".addmore").on('click', function() {
        ...
        data += '\n\\n\
                                ...
                                <td>\n\
                                    <input type="text" id="COD_PROD_' + i + '" name="COD_PROD[]" size="10" class="form-control"/>\n\
                                </td>\n\
                                <td>\n\

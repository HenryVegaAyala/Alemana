...
<html>
    ...
    <table class="table table-bordered table-condensed table-responsive table-striped table-hover table-wrapper" id="tableP">
        ...
        $sqlStatement = "SELECT DES_LARG,COD_PROD,NRO_UNID,VAL_PREC,VAL_MONT_UNID 
            FROM 
...
<script>
    ...
    $(".addmore").on('click', function() {
        ...
        data += '\n\\n\
                                <td>\n\
                                    <input type="text" id="DES_LARG_' + i + '" name="DES_LARG[]" size="45" class="form-control" value="<?php echo $DESCRI ?>" />\n\
                                </td> \n\
                                <td>\n\

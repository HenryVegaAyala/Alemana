 ...
 */
class SEGUSUAR extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('USE_USUA, PAS_USUA, USU_DIGI, USU_MODI', 'length', 'max'=>50),
			...
			array('COD_USUA, COD_LOCA, NOM_USUA, APE_USUA, USE_USUA, PAS_USUA, EMA_USUA, EST_USUA, FEC_ULTI_INGR, FEC_ULTI_MODI_PASS, VAL_INTE_FALL_PASS, USU_DIGI, FEC_DIGI, USU_MODI, FEC_MODI, VAL_IP, IND_ACCE', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return SEGUSUAR the static model class
	 */

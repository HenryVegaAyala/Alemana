...
class SEGUSUAR extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('EST_USUA, VAL_INTE_FALL_PASS', 'length', 'max' => 1),
            array('VAL_IP', 'length', 'max' => 15),
            array('FEC_ULTI_INGR, FEC_ULTI_MODI_PASS, FEC_DIGI, FEC_MODI', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('COD_USUA, COD_LOCA, NOM_USUA, APE_USUA, USE_USUA, PAS_USUA, EMA_USUA, EST_USUA, FEC_ULTI_INGR, FEC_ULTI_MODI_PASS, VAL_INTE_FALL_PASS, USU_DIGI, FEC_DIGI, USU_MODI, FEC_MODI, VAL_IP', 'safe', 'on' => 'search'),
        );
    }

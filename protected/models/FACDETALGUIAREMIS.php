...
/**
 * This is the model class for table "FAC_DETAL_GUIA_REMIS".
 *
 * The followings are the available columns in table 'FAC_DETAL_GUIA_REMIS':
 * @property string $COD_GUIA
 * @property string $COD_PROD
 * @property string $PES_PROD
 ...
 * @property string $GUIA_DET
 *
 * The followings are the available model relations:
 * @property FACGUIAREMIS $cODGUIA
 * @property MAEPRODU $cODPROD
 */
class FACDETALGUIAREMIS extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('COD_GUIA, COD_PROD, PES_PROD, UNI_SOLI, VAL_PROD, IMP_PROD, IGV_PROD, IMP_TOTA_PROD', 'length', 'max'=>12),
			array('USU_DIGI, USU_MODI', 'length', 'max'=>20),
			array('FEC_DIGI, FEC_MODI', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('COD_GUIA, COD_PROD, PES_PROD, UNI_SOLI, VAL_PROD, IMP_PROD, IGV_PROD, IMP_TOTA_PROD, USU_DIGI, FEC_DIGI, USU_MODI, FEC_MODI, GUIA_DET', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('GUIA_DET',$this->GUIA_DET,true);
	 ...
	 * @return FACDETALGUIAREMIS the static model class
	 */
